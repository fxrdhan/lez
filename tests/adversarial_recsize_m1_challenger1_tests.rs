...
//! Adversarial empirical test suite by Challenger 1 for Milestone 1 (R1: Total Size Traversal):
//! - Parent directory `..` recursive size exclusion across all flag permutations and boundaries
//! - Complex multi-level hardlink mesh across nested subdirectories with independent subtree verification
//! - Cross-partition of hardlinks across visible and hidden directory trees with dotfile filter toggling
//! - Sibling directory arguments with shared hardlinks
//! - Property-based random directory tree generator with independent ground-truth oracle
//! - Permission denial and resilience under unreadable subtrees
...
// =========================================================================
// 1. PARENT DIRECTORY `..` EXCLUSION UNDER ALL CLI FLAG PERMUTATIONS
// =========================================================================

#[test]
fn test_parent_dir_exclusion_under_all_flag_permutations() {
...
// =========================================================================
// 4. MULTI-DIRECTORY ARGUMENTS WITH SHARED HARDLINKS
// =========================================================================

#[test]
fn test_adversarial_multi_directory_arguments_with_shared_hardlinks() {
...
#[test]
fn test_adversarial_property_fuzz_random_tree() {
...
// =========================================================================
// 6. PERMISSION DENIAL RESILIENCE UNDER UNREADABLE SUBTREES
// =========================================================================

#[test]
#[cfg(unix)]
fn test_adversarial_unreadable_subtree_graceful_handling() {
    use std::os::unix::fs::PermissionsExt;
