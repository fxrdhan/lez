...
Register-ArgumentCompleter -Native -CommandName 'eza' -ScriptBlock {
    ...
    $ArraySort           = @('name', 'Name', 'lexicographic', 'Lexicographic', 'lex', 'Lex', 'lg', 'Lg', 'extension', 'Extension', 'path', 'Path', 'relative-path', 'Relative-path', 'Relative-Path', 'relpath', 'Relpath', 'relative_path', 'Relative_path', 'size', 'filesize', 'loc', 'code', 'lines', 'percent', 'percentage', 'block', 'blocks', 'blocksize', 'type', 'created', 'modified', 'mod', 'date', 'time', 'old', 'oldest', 'age', 'new', 'newest', 'accessed', 'changed', 'inode', 'none')
