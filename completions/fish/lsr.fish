...
# `lsr --absolute=on`. Offering those values after a space would build a
...
function __lsr_value_follows_an_equals_sign
...
complete -c lsr -l classify -d "Display type indicator by file names" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
"
complete -c lsr -l color -l colour -d "When to use terminal colours"
complete -c lsr -l color \
    -l colour -d "When to use terminal colours" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
"
complete -c lsr -l color-scale -l colour-scale -d "Highlight levels 'field' distinctly"
complete -c lsr -l color-scale \
    -l colour-scale -d "Highlight levels 'field' distinctly" -x -n "__lsr_value_follows_an_equals_sign" -a "
    all\t''
    age\t''
    size\t''
"
...
"
complete -c lsr -l icons -d "When to display icons"
complete -c lsr -l icons -d "When to display icons" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
"
complete -c lsr -l quotes -d "When to quote filenames"
complete -c lsr -l quotes -d "When to quote filenames" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
complete -c lsr -l hyperlink -d "When to display entries as hyperlinks"
complete -c lsr -l hyperlink -d "When to display entries as hyperlinks" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
complete -c lsr -l absolute -d "Display entries with their absolute path"
complete -c lsr -l absolute -d "Display entries with their absolute path" -x -n "__lsr_value_follows_an_equals_sign" -a "
...
complete -c lsr -l code -d "Summarise lines of code by language"
complete -c lsr -l code -d "Summarise lines of code by language" -x -n "__lsr_value_follows_an_equals_sign" -a "lines percent both"
...
complete -c lsr -l loc -d "Add lines-of-code and language columns"
complete -c lsr -l loc -d "Add lines-of-code and language columns" -x -n "__lsr_value_follows_an_equals_sign" -a "lines percent both"
...
complete -c lsr -l stdin -d "When piping to lsr. Read file names from stdin"
