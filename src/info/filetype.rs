...
const EXTENSION_TYPES: Map<&'static str, FileType> = phf_map! {
    ...
    "wasm"       => FileType::Compiled, // WebAssembly binary
    ...
    "astro"      => FileType::Source, // Astro
    "awk"        => FileType::Source, // awk
    "bash"       => FileType::Source, // Bash script
    ...
    "fish"       => FileType::Source, // Fish shell script
    ...
    "gql"        => FileType::Source, // GraphQL
    "gradle"     => FileType::Source, // Gradle
    "graphql"    => FileType::Source, // GraphQL
    ...
    "htm"        => FileType::Source, // HTML
    "html"       => FileType::Source, // HTML
    ...
    "jdn"        => FileType::Source, // Janet
    "jl"         => FileType::Source, // Julia
    "js"         => FileType::Source, // JavaScript
    "jsx"        => FileType::Source, // React JSX
    ...
    "proto"      => FileType::Source, // Protocol Buffers
