...
const EXTENSION_ICONS: Map<&'static str, char> = phf_map! {
    ...
    "nix"            => '\u{f313}',              // 
    "node"           => Icons::NODEJS,           // 
    "npy"            => Icons::LANG_PYTHON,      // 
    "npz"            => Icons::LANG_PYTHON,      // 
    "norg"           => '\u{e847}',              // 
    "nsp"            => '\u{F07E1}',             // 󰟡
    "nu"             => Icons::SHELL_CMD,        // 
    "o"              => Icons::BINARY,           // 
    ...
    "phar"           => Icons::LANG_PHP,         // 
    "php"            => Icons::LANG_PHP,         // 
    "pickle"         => Icons::LANG_PYTHON,      // 
    "pkg"            => '\u{eb29}',              // 
    "pkl"            => Icons::LANG_PYTHON,      // 
    "pl"             => Icons::LANG_PERL,        // 
...
const MIME_ICONS: Map<&'static str, char> = phf_map! {
    ...
    "application/x-hdf5"           => Icons::DATABASE,
    "application/x-parquet"        => Icons::DATABASE,
    "application/x-sqlite3"        => Icons::SQLITE,
